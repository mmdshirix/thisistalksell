        ...
        <Tabs defaultValue="stats" className="space-y-8">
          ...
          <TabsContent value="stats" className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <StatsCard title="پیام‌های امروز" value={data.stats.todayMessages} icon={MessageCircle} />
              <StatsCard title="کل کاربران" value={data.stats.uniqueUsers} icon={Users} />
              <StatsCard title="تیکت‌های فعال" value={data.stats.activeTickets} icon={Ticket} />
