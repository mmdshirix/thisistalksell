...
export default function TicketForm({ chatbotId, onClose, onShowTickets }: TicketFormProps) {
  ...
  const priorityOptions = [
    ...
    { value: "normal", label: "متوسط", color: "text-blue-600" },
    { value: "high", label: "بالا", color: "text-red-600" },
  ]
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pr-10 border-gray-300 dark:border-gray-600 rounded-xl"
                dir="ltr"
              />
            </div>
          </div>
  ...
  return (
    <Card className="w-full max-w-lg mx-auto border-gray-200 dark:border-gray-700">
      <CardHeader className="text-center pb-4">
        <CardTitle className="text-xl text-gray-900 dark:text-white flex items-center justify-center gap-2">
          <MessageSquare className="w-6 h-6 text-blue-600" />
          ارسال تیکت جدید
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pr-10 bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600 rounded-xl"
                readOnly
                dir="ltr"
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="border-gray-300 dark:border-gray-600 rounded-xl">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[100px] resize-none border-gray-300 dark:border-gray-600 rounded-xl"
              required
            />
          </div>
              ...
              {imagePreview ? (
                ...
                <div>
                  ...
                  <Label
                    ...
                    className="inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                  >
                    انتخاب فایل
                  </Label>
                </div>
